...
const categories = [
  ...
  { label: "Relaciones y Apego", href: "/blog?cat=relaciones-apego" },
  { label: "Autoconocimiento", href: "/blog?cat=autoconocimiento" },
  { label: "Limites y Asertividad", href: "/blog?cat=limites-asertividad" },
  { label: "Desmitificacion", href: "/blog?cat=desmitificacion" },
  { label: "Psicologia Cotidiana", href: "/blog?cat=psicologia-cotidiana" },
];

const socials = [
  { label: "Instagram", href: "https://instagram.com/egoera.psikologia", icon: () => (
  ...
  { label: "TikTok", href: "https://tiktok.com/@egoera.psikologia", icon: () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
      <path d="M19.59 6.69a4.83 4.83 0 01-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 01-2.88 2.5 2.89 2.89 0 01-2.89-2.89 2.89 2.89 0 012.89-2.89c.28 0 .54.04.79.1v-3.5a6.37 6.37 0 00-.79-.05A6.34 6.34 0 003.15 15.2a6.34 6.34 0 006.34 6.34 6.34 6.34 0 006.34-6.34V8.73a8.19 8.19 0 004.76 1.52V6.81a4.84 4.84 0 01-1-.12z"/>
    </svg>
  )},
  { label: "YouTube", href: "https://youtube.com/@egoera.psikologia", icon: () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
    </svg>
  )},
  { label: "X", href: "https://x.com/egoerapsikolog", icon: () => (
    <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
